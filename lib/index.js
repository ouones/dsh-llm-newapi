...
*/
function discoverModelApi(endpoints) {
	if (endpoints === void 0) return void 0;
	return endpoints.map(protocolOfEndpoint).filter((api) => api !== void 0)[0];
}
/**
...
async function handleModels(req, res, ctx, deps) {
	...
	try {
		...
		responseJson(res, 200, { models: (await deps.discover(baseURL, apiKey, provider)).map((model) => ({
			...
			...discoverModelApi(model.endpoints) === void 0 ? {} : { api: discoverModelApi(model.endpoints) }
		})) });
	} catch (error) {
