...
function NewApiSection(props) {
    ...
    }), React.createElement('div', { style: hintStyle }, t('apiKeyEnvHint'))), React.createElement('div', { style: rowStyle }, React.createElement('label', { style: labelStyle }, t('reasoning')), React.createElement('select', {
        style: inputStyle,
        value: reasoning,
